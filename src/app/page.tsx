...
export default function Home() {
  return (
    <main className="flex-1">
      ...
      <section className="py-16" aria-labelledby="paylater-heading">
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center">
            <div className="flex flex-col justify-center items-start w-full flex-1">
              <div className="hidden lg:flex flex-col items-start">
                ...
                <h2
                  id="paylater-heading"
                  className="text-6xl font-oswald font-bold text-black mb-4"
                >
                  PAYLATER
                </h2>
              </div>
              ...
              <ul
                ...
                aria-label="PayLater process steps"
              >
              ...
              <ButtonLink
                ...
                rounded
                href="/register"
                aria-label="Register as a Bumper partner"
              />
            </div>
            <div className="min-w-[350px] sm:min-w-[480px]">
              <Image
                src="/images/phone-mobile-app.png"
                alt="Bumper mobile app interface showing payment options"
                className="p-6"
                width={488}
                height={400}
              />
